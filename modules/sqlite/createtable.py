...
def createdb():
    ...
    defmagicplayer INTEGER NOT NULL,
    defphysicalplayer INTEGER NOT NULL,
    ...
    defmagicmob INTEGER NOT NULL,
    defphysicalmob INTEGER NOT NULL,
    dexteritymob INTEGER NOT NULL,
    intelligencemob INTEGER NOT NULL,
    healthmob INTEGER NOT NULL,
    manamob INTEGER NOT NULL,
    xpmob INTEGER NOT NULL,
    lvlmob INTEGER NOT NULL,
    pointsmob INTEGER NOT NULL,
    crdate datetime)
    """)
    cursor.commit()
